import feast from '../../../assets/feast2.jpg'
    ...
    <section className='max-w-screen-xl my-5 mx-auto text-white p-10'>
      <div className='flex flex-col  md:flex-row gap-5'>
        <div className='text-white w-full md:w-1/2 z-20'>
          <h1 className='text-2xl font-pirate text-secondary font-bold'>
          ...
          <h2 className='text-xl mt-2 font-pirate text-secondary'>
          ...
          <button className='text-primary bg-secondary mt-5 py-2 px-6 font-semibold rounded shadow-md hover:from-yellow-300 font-pirate hover:to-secondary hover:scale-105 transform transition-all duration-300 ease-in-out'>
